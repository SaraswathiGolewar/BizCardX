...
connection=mysql.connector.connect(host="localhost",user="root",password="12345",database="BizCard")
mycursor=connection.cursor()
mycursor.execute('CREATE DATABASE if not exists BizCard')
mycursor.execute('Use BizCard')

# SETTING PAGE CONFIGURATIONS
icon = Image.open(r"C:\Users\vihari\OneDrive\Desktop\Bizlogo.png")
...
if selected == "Home":
    ...
    with col1:
        st.image(Image.open(r"C:\Users\vihari\OneDrive\Desktop\Bizlogo.png"), width=450)
